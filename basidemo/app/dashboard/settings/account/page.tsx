            ...
            <section className='mb-8'>
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <input type="text" placeholder="Enter new password" className='mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg
                  shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500'/>
                </div>
                <div>
                  <label className='block text-sm font-medium text-gray-600'>Confirm Password</label>
                  <input type="text" placeholder="Confirm new password" className='mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg
                  shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500'/>
                </div>
              </div>
            </section>
