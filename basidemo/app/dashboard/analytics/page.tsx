  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-8'>
       <div className='max-w-7xl mx-auto bg-white rounded-lg shadow-xl p-8'>
        ...
        {/* Charts Sections (Placeholder For Graph) */}
        <div className='mb-8'>
          <h2 className='text-xl font-semibold text-gray-700 mb-4'>Website Traffic</h2>
          <div className='bg-gray-100 rounded-lg h-72 p-2'>Charts Placeholder</div>
        </div>
        <div className='mb-8'>
          <h2 className='text-xl font-semibold text-gray-700 mb-4'>Website Traffic</h2>
          <div className='bg-gray-100 rounded-lg h-72 p-2'>Charts Placeholder</div>
          ...
          <ul className='space-y-4'>
            <li className='flex items-center justify-between bg-white rounded-lg shadow-md p-4'>
              <div>
                ...
                <p className='text-sm text-gray-600'>New user signed up on 2026-02-01</p>
              </div>
              <div>
